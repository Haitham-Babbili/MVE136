...
plot(f,PdB)
 ...
 plot(f0,y)
 hold off
 title('Periodogram vs. True Spectrum')
...
PB = PB(1:N/2);
 ...
 hold off
 title('Periodogram smoothing')
 legend('Blackman-Tukey, M=64','Blackman-Tukey, M=15','Bartlett')
 xlabel('Frequency')
ylabel('Amplitude dB')
...
plot(f0,Y_w)
hold off
title('Spectra of desired signal and disturbance')
legend('d[n]','w[n]')
xlabel('Frequency')
ylabel('Amplitude dB')
